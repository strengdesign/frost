...
<div class="paddingDiv">
    ...
    <h1 class="styled"><xsl:value-of select="$currentPage/articleTitle" /></h1>
    ...
    <div id="industry-tags">
        <xsl:variable name="preNodes">
            <xsl:variable name="industries" select="$currentPage/articleIndustries" />
    ...
    <div id="services-tags">
        <xsl:variable name="preNodes">
            <xsl:variable name="services" select="$currentPage/articleServices" />
    ...
    <p><xsl:value-of select="$currentPage/articleText" disable-output-escaping="yes" /></p>
